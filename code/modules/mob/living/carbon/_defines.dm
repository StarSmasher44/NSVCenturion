...
#define COLD_DAMAGE_LEVEL_3 3.5 //Amount of damage applied when your body temperature passes the 120K point
...
#define COLD_GAS_DAMAGE_LEVEL_3 3.5 //Amount of damage applied when the current breath's temperature passes the 120K point