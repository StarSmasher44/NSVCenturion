...
/proc/readglobal(which)
	switch(which)
		...
		if("lighting_update_static")
			return global.lighting_update_static;
...
/proc/writeglobal(which, newval)
	switch(which)
		...
		if("lighting_update_static")
			global.lighting_update_static=newval
		if("lighting_update_corners")
